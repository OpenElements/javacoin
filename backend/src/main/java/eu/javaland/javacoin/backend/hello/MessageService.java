package eu.javaland.javacoin.backend.hello;
...
public class MessageService {
    ...
    private final eu.javaland.javacoin.contract.generated.MessageStoreContract contract;

    public MessageService(final eu.javaland.javacoin.contract.generated.MessageStoreContract contract) {
