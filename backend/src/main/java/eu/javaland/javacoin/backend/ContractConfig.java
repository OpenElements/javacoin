package eu.javaland.javacoin.backend;
...
public class ContractConfig {
    ...
    @Bean
    @ApplicationScope
    public eu.javaland.javacoin.contract.generated.MessageStoreContract helloWorldContract(final Web3j web3j,
        ...
        try {
            ...
            return createContractWrapper(web3j, credentials,
                    eu.javaland.javacoin.contract.generated.MessageStoreContract.class, contractId);
    ...
    @Bean
    @ApplicationScope
    public JavaCoinContract javaCoinContract(final Web3j web3j, final Credentials credentials) {
        try {
            final ContractId contractId = ContractId.fromString(javaCoinContractAddress);
            return createContractWrapper(web3j, credentials, JavaCoinContract.class, contractId);
        } catch (final Exception e) {
            throw new RuntimeException("Error while creating contract wrapper", e);
        }
    }
